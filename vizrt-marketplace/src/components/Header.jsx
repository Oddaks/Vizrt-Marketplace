...
const Header = () => {
  ...
  return (
    <header className="navbar bg-white text-black p-2">
      <div className="logo absolute top-2 left-2 w-64 h-24"></div>
      <nav>
        <ul className="nav-links list-none m-0 p-0 flex">
          <li className="arrowback absolute top-32 left-7 w-6 h-5 flex items-start flex-shrink-1 mr-2"></li>
          ...
          <li className="dropdown mr-2">
            <button onClick={() => setShowMenu(!showMenu)} className="dropdown-button bg-white text-black p-1 no-underline">
