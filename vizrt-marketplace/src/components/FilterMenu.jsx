        ...
        <div className="col-span-1 p-4 space-y-4">
             <div className="mb-4 flex items-center justify-center">
                ...
                <div className="flex items-center relative border border-gray-300 rounded-full overflow-hidden w-24" onClick={toggleVerifiedUser}>
                    ...
                    <div className="absolute h-5 w-5 bg-white rounded-full shadow-md transform duration-300 border border-gray-300" style={{ left: verifiedUser === 'true' ? 'calc(100% - 1.25rem)' : '0.125rem', transition: 'left 0.2s ease-in-out' }} />
                </div>
            ...
            <div>                    
                ...
                <div className="p-4 bg-viz-green border border-[#82AAB9] space-y-2">
                    <label className={`block cursor-pointer ${color === 'Red' ? 'text-orange-500' : 'text-white'}`} onClick={() => toggleColor('Red')}>Red</label>
                    <label className={`block cursor-pointer ${color === 'White' ? 'text-orange-500' : 'text-white'}`} onClick={() => toggleColor('White')}>White</label>
                    <label className={`block cursor-pointer ${color === 'Blue' ? 'text-orange-500' : 'text-white'}`} onClick={() => toggleColor('Blue')}>Blue</label>
                    <label className={`block cursor-pointer ${color === 'Black' ? 'text-orange-500' : 'text-white'}`} onClick={() => toggleColor('Black')}>Black</label>
                    <label className={`block cursor-pointer ${color === 'Multicolor' ? 'text-orange-500' : 'text-white'}`} onClick={() => toggleColor('Multicolor')}>Multicolor</label>
                    <label className={`block cursor-pointer ${color === 'Pastel' ? 'text-orange-500' : 'text-white'}`} onClick={() => toggleColor('Pastel')}>Pastel</label>
                    <label className={`block cursor-pointer ${color === 'Pink' ? 'text-orange-500' : 'text-white'}`} onClick={() => toggleColor('Pink')}>Pink</label>
                    <label className={`block cursor-pointer ${color === 'Purple' ? 'text-orange-500' : 'text-white'}`} onClick={() => toggleColor('Purple')}>Purple</label>
                    <label className={`block cursor-pointer ${color === 'Orange' ? 'text-orange-500' : 'text-white'}`} onClick={() => toggleColor('Orange')}>Orange</label>
                    <label className={`block cursor-pointer ${color === 'Neon' ? 'text-orange-500' : 'text-white'}`} onClick={() => toggleColor('Neon')}>Neon</label>
                </div>
            </div>
            <div>                    
                <h3 className="text-xl font-extrabold text-orange-500 text-center">Price</h3>
                <div className="p-4 bg-viz-green border border-[#82AAB9] space-y-2">
